...
List<AllAgents> allAgentsFromJson(data) => List<AllAgents>.from(data.map((x) => AllAgents.fromJson(x)));

String allAgentsToJson(List<AllAgents> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class AllAgents {
  ...
  factory AllAgents.fromJson(Map<String, dynamic> json) => AllAgents(
    id: json["id"],
